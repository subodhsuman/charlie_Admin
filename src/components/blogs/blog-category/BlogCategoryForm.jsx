...
const Form = ({BlogCategoryList}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {   
            setLoading(true)
            let response = await ApiClass.postNodeRequest(`category/create`,true,values);
            setLoading(false)
            ...
            if(response?.data?.status_code == 1){
                ...
                resetForm()
                document.getElementById('blogCategoryClose').click(); 
                BlogCategoryList();
                return
            }
        }
    ...
    return (
        <>
            <div className="modal fade common-modal" id="blogCategoryModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
                <div className="modal-dialog modal-md modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            &nbsp;Add New Blog Category </h5>
                            <button type="button" className="btn p-0 border-0" data-bs-dismiss="modal" aria-label="Close" id="blogCategoryClose" onClick={()=>resetForm()}>
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="mb-3">
                                            <label htmlFor="staticName" className="col-form-label">Blog Category Name</label>
                                            <input className="form-control" type="text" placeholder="Enter Blog Category Name" name="name" value={values.name} onChange={handleChange} />
                                    ...
                                    {loading ?
                                        <button className="export-btn text-center" type="button" disabled>
                                            <div className="btn">
