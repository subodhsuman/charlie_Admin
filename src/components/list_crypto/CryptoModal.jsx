...
const CryptoModal = ({ cryptoData, getCrypto }) => {

    const [loading, setLoading] = useState(false);

    const { values, handleSubmit, handleChange, errors, touched, setFieldValue, resetForm } = useFormik({
        initialValues: {
            id: '',
            buy: '',
            buy_min: '',
        ...
        onSubmit: async (values) => {
            ...
            setLoading(true)
            let response = await ApiClass.updateRequest(`crypto/update`, true, values);
            setLoading(false)
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6 col-xl-4">
                                        <div className="mb-3">
                                            ...
                                            <div className="input-group">
                                                <input className="form-control" type="text" placeholder="Min" name="buy_min"
                                    ...
                                    <div className="col-md-6 col-xl-4">
                                        <div className="mb-3">
                                            ...
                                            <div className="input-group">
                                                <input className="form-control" type="text" placeholder="Max" name="buy_max"
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <div className="d-flex gap-2">
                                                ...
                                                <div className="input-group">
                                                    <input className="form-control" type="text" placeholder="Commission" name="buy_commission"
                                                        value={values.buy_commission || ''}
                                                        onChange={handleChange}
                                                        onKeyPress={(e) => onHandleKeyPress(e, 8)}
                                                        onKeyUp={(e) => onHandleKeyUp(e)}
                                                        onKeyDown={(e) => onHandleKeyDown(e)}
