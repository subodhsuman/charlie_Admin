...
const Form = ({getUpi}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async(values)=>{
            setLoading(true)
            let response = await ApiClass.postRequest('adminupis/create',true,values);
            setLoading(false)
    ...
    return (
        <>
            <div className="modal fade common-modal" id="adminUpiModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
