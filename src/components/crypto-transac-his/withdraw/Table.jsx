...
const Table = ({data,pagination,handlePageClick,setName,setAmount,setDate,setStatus,setCur_rency,getCryptoWithdraw,setSortBy,setSortName,sortBy, setLoader, loader, setViewData, setChainType, setUniqueId}) => {
                ...
                <tbody>
                        <tr>
                            ...
                            <form onSubmit={searchBy}>
                                    <div className="form-floating">
                                        <input type="text" className="form-control" id="floadingName" onChange={(e) => setCur_rency(e.target.value)}/>
                                        <label htmlFor="floadingName">Search By Currency</label>
                                    </div>
                                </form>
                            </td>
                            <td>
                            <form onSubmit={searchBy}>
                                    <div className="form-floating">
                                        <input type="text" className="form-control" id="floadingName" onChange={(e)=> setChainType(e.target.value)} />
                            ...
                            <td >
                                ...
                                <div className="form-floating">
                                    ...
                                    <label htmlFor="floadingEmail">Search By UniqueId</label>
                                </div>
                                </form>
                            </td>
                            <td >
                    ...
                    <thead>
                        <tr>
                            ...
                            <div className="d-flex justify-content-between">
                                <span>Chain</span>
                                <button className="btn p-0 border-0" onClick={() => sorting('chain_type')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 48 48" fill="var(--white)"><path d="M16.1 25.5V9.7l-6 6L8 13.6l9.65-9.65 9.65 9.65-2.1 2.1-6.1-6.05V25.5Zm14.25 18.45-9.65-9.7 2.1-2.05 6 6V22.4h3v15.85l6.1-6.05 2.1 2.1Z" /></svg>
                                </button>
                            </div>
                            </th>
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <div className="export-btn">
                                        <button className="btn" data-bs-toggle="modal" data-bs-target="#cryptoViewModal" onClick={()=>setViewData(val)}>View</button>
                                    </div>
                                </td>
                            </tr>
                            ))
