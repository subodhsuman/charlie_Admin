...
const Table = ({data,pagination,handlePageClick,setName,setEmail,setDate,setUserStatus,getClient,setDurtion,setSortBy,setSortName,sortBy,handleOnExport,setLoader,loader}) => {
                    ...
                    <table className="table align-middle table-bordered w-100" id="table-container">
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <form action="" className="status-form">
                                        <select className="form-select" aria-label=".form-select-lg" onChange={(e) => setUserStatus(e.target.value)}>
                         ...
                         {data?.map((v, i) => {
                           return (
                            <tr key={i}>
                                ...
                                <td ><span className={`badge ${checkStatus(v?.user_verify == true? "Verified" : "UnVerified" )}`}>
                                     {(v?.user_verify == true) ? "Verified" : "UnVerified"}</span>
                                </td>
