...
const Table = ({data,pagination,handlePageClick,setName,setprice,setDate,setTotal_,setType,setQuantity,setStatus,getP2pOrderList,setSortBy,setSortName,sortBy,handleOnExport,setLoader,loader}) => {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="number" className="form-control" id="floadingName" onChange={(e) => setQuantity(e.target.value)} />
                                ...
                                <td >
                                    <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="number" className="form-control" id="floadingName" onChange={(e) => setprice(e.target.value)}/>
                                ...
                                <td >
                                    <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="number" className="form-control" id="floadingName" onChange={(e) => setTotal_(e.target.value)} />
                          ...
                          {data?.map((v, i) => {
                           return (
                            <tr key={i} >
                                ...
                                <td><span className={`badge ${checkStatus(v?.order_type)}`}>
                                   {v?.order_type}</span>
                                </td>
                                <td>
                                    {v?.max_quantity}
