...
const Table = ({data,pagination,handlePageClick,setName,setEmail,setCurrency,setAmount,setStatus,setDate,setTransaction_type,getP2pTransList,handleOnExport,setLoader,loader}) => {
                    ...
                    <table className="table align-middle table-bordered w-100" id="table-container">
                        <tbody>
                            <tr>
                                ...
                                <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="text" className="form-control" id="floadingName" onChange={(e) => setCurrency(e.target.value)}/>
                                ...
                                <td >
                                    <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="text" className="form-control" id="floadingName" onChange={(e) => setAmount(e.target.value)} />
                                            <label htmlFor="floadingName">Search By Amount</label>
                                        </div>
                                    </form>
                                </td>
                                <td >
                                ...
                                <form action="" className="status-form">
                                        <select className="form-select" aria-label=".form-select-lg" onChange={(e) =>  setTransaction_type(e.target.value) }>
                          ...
                          {data?.map((v, i) => {
                           return (
                            <tr key={i} >
                                ...
                                <td><span className={`badge ${checkStatus(v?.transaction_type)}`}>
                                   {v?.transaction_type}</span>
                                </td>
                                <td>
