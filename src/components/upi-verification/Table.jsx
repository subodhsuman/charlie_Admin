...
const Table = ({ data, pagination, handlePageClick, setAlias, setEmail, setUpi, setDate, setStatus, getUpi, setViewData,handleOnExport,setSortBy,setSortName,sortBy }) => {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td >
                                    <form onSubmit={searchBy}>
                                        <div className="form-floating">
                                            <input type="text" className="form-control" id="floadingName" onChange={(e) => setUpi(e.target.value)} />
                                            <label htmlFor="floadingName">Search By Upi Id</label>
                                        </div>
                                    </form>
                                </td>
                                <td >
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <div className="d-flex justify-content-between">
                                        <span>Upi Id</span>
                                        <button className="btn p-0 border-0" onClick={() => sorting('upi_id')}>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 48 48" fill="var(--white)"><path d="M16.1 25.5V9.7l-6 6L8 13.6l9.65-9.65 9.65 9.65-2.1 2.1-6.1-6.05V25.5Zm14.25 18.45-9.65-9.7 2.1-2.05 6 6V22.4h3v15.85l6.1-6.05 2.1 2.1Z" /></svg>
                                        </button>
                                    </div>
                                </th>
                                            ...
                                            return (
                                                <tr key={i}>
                                                    ...
                                                    <td className="text-center">
                                                        <span className={`badge ${handleStatus(v?.verify_status)}`}>{v?.verify_status}</span>
                                                    </td>
                                                    <td>
                                                        <div className="export-btn">
                                                            <button className="btn text-capitalize" data-bs-toggle="modal" data-bs-target="#upiVerifyModal" onClick={() => setViewData(v)}>
                                                                view
                                                            </button>
                                                        </div>
