...
const Form = ({ getBank }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setLoading(true)
            let response = await ApiClass.postRequest(`adminbanks/create`, true, values);
            setLoading(false)
            ...
            if (response?.data?.status_code == 1) {
                ...
                document.getElementById('adminbankcreatebtn').click();
                resetForm()
                getBank();
                return
            }
    ...
    return (
        <>
            <div className="modal fade common-modal" id="adminBankModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title text-uppercase d-flex align-items-center" id="exampleModalLabel">
                                ...
                                &nbsp;Add New Bank </h5>
                            <button type="button" className="btn p-0 border-0" data-bs-dismiss="modal" aria-label="Close" id="adminbankcreatebtn">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <input className="form-control" type="text" placeholder="" name="bank_name" value={values.bank_name || ''} onChange={handleChange} />
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" aria-label=".form-select-lg" name="account_type" value={values.account_type || ''} onChange={handleChange}>
