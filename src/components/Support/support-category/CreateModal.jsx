 ...
 const [loading,setLoading] = useState(false);
    const formik = useFormik({
        ...
        onSubmit: async(values)=>{
            let response = await ApiClass.postRequest('ticket/category_create',true,values);
            ...
            if(response?.data?.status_code == 1){
                ...
                document.getElementById('createCategoryModalbtn').click();
                resetForm();
                getCategory();
                return
            }
  ...
  return (
    <>
        <div className="modal fade common-modal" id="createCategoryModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-md modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            &nbsp;Add Support Category </h5>
                            <button type="button" className="btn p-0 border-0" data-bs-dismiss="modal" aria-label="Close" id="createCategoryModalbtn">
