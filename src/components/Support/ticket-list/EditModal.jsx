...
const EditModal = ({data, getTickets}) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async(values) => {
            setLoading(true)
            let response = await ApiClass.updateRequest(`ticket/update?id=${id}`,true,values);
            setLoading(false)
            ...
            if(response?.data?.status_code == 1){
                ...
                document.getElementById('editTicketModalbtn').click();
                getTickets();
                return
            }
        }
    ...
    const statusArr = ["open","close","inprogress"];
    ...
    return(
        <>
            <div className="modal fade common-modal" id="editTicketModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-md modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            ...
                            &nbsp;Edit Priority and Status </h5>
                            <button type="button" className="btn p-0 border-0" data-bs-dismiss="modal" aria-label="Close" id="editTicketModalbtn">
