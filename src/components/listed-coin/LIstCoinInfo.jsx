...
const LIstCoinInfo = ({contractDetail, contractError}) => {



  return (
    <div className="modal fade common-modal" id="listCoinInfoModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div className="modal-content">
            <div className="modal-header">
                <h5 className="modal-title text-uppercase d-flex align-items-center" id="exampleModalLabel">
                    ...
                    Contract Detail </h5>
                <button type="button" className="btn p-0 border-0" data-bs-toggle="modal" data-bs-target="#listcoinmodal" aria-label="Close" id="listformClose" >
            ...
            <div className="modal-body admin-form">
                {contractError != undefined && 
                    <p className='mb-0 text-center'>{contractError}</p>
                }
