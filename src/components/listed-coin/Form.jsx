...
const Form = () => {
    ...
    return (
        <>
            <div className="modal fade common-modal" id="listCoin" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog modal-lg modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-body admin-form">
                            <form>
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            <label htmlFor="staticReferral" className="col-form-label">Referral</label>
                                            <input className="form-control" type="text" placeholder="Enter Referral" />
                                        </div>
                                    </div>
                                    {/* <div className="col-md-6">
                        <div className="mb-3">
                        ...
                        <select className="form-select mb-3" aria-label=".form-select-lg" onChange={(e)=>setStatus(e.target.value)}>
                            <option value=""></option>
