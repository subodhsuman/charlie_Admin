...
const Table = ({data,pagination,handlePageClick,setName,setAmount,setDate,setStatus,setSymbol,getBankDeposit,setSortBy,setSortName,sortBy,setLoader,loader}) => {
