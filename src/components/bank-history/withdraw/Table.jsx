...
const Table = ({ data, pagination, handlePageClick, setName, setAmount, setDate, setStatus, setCur_rency, getBankWithdraw, setSortBy, setSortName, sortBy, setLoader, loader }) => {
