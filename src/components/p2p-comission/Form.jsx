...
const Form = ({ getComission }) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            // buy_comission_status: Yup.string().required('buy_comission_status Type is required.'),
            sell_comission_status: Yup.string().required('buy_comission_status Type is required.'),
            status: Yup.string().required('status is required.'),
        }),
        onSubmit: async (values) => {
            setLoading(true)
            let response = await ApiClass.postNodeRequest(`P2P/P2pComission/create`, true, values);
            ...
            if (response?.data?.status_code == 1) {
                ...
                document.getElementById('adminp2pcreatebtn').click();
                resetForm()
                getComission();
                return
            }
    ...
    return (
        <>
            <div className="modal fade common-modal" id="adminp2pcomissionModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title text-uppercase d-flex align-items-center" id="exampleModalLabel">
                                ...
                                &nbsp;New P2p Comission </h5>
                            <button type="button" className="btn p-0 border-0" data-bs-dismiss="modal" aria-label="Close" id="adminp2pcreatebtn">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            <label htmlFor="staticName" className="col-form-label">currency</label>
                                            <input className="form-control" type="text" placeholder="currency" name="currency"
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            <label htmlFor="staticName" className="col-form-label">pair_with</label>
                                            <input className="form-control" type="text" placeholder="pair_with" name="pair_with"
                                                value={values.pair_with || ''}
                                                onChange={handleChange}
                                            />
                                    ...
                                    {/* <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" aria-label=".form-select-lg" name="buy_comission_type" value={values.buy_comission_type || ''} onChange={handleChange}>
                                    ...
                                    <div className="col-md-6">
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" aria-label=".form-select-lg" name="sell_comission_type" value={values.sell_comission_type || ''} onChange={handleChange}>
                                                <option value="">Select Comission Type</option>
                                                <option value="percentage">Percentage</option>
                                                <option value="flat">Flat</option>
                                            </select>
